...
void loop() {
  ...
  if (((rFront <= 60) || (lFront <= 60)) || ((rFront <= 60) && (lFront <= 60)))
  {
    ...
    else
    {
      ...
      if (rFront <= lFront)
      {
        //Если расстояние с правого датчика больше 40, но меньше frontHigh
        ...
        //Если расстояние с правого датчика меньше 40, но больше frontLow
